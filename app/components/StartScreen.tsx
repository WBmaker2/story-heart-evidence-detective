...
export function StartScreen({ onTutorial, onSkipTutorial }: StartScreenProps) {
  return (
    <section className="start-screen" aria-labelledby="start-title">
      ...
      <div className="start-notebook" aria-label="수사 방법 네 단계">
        <div className="paper-tab"><BookIcon /> 수사 노트</div>
        <ol>
          <li><span>1</span><div><strong>이야기 읽기</strong><p>마음을 살필 장면을 찾아요.</p></div></li>
          <li><span>2</span><div><strong>마음 고르기</strong><p>인물의 마음이나 생각을 하나 골라요.</p></div></li>
          <li><span>3</span><div><strong>단서 연결</strong><p>고른 마음과 단서 카드 두 장을 연결해요.</p></div></li>
          <li><span>4</span><div><strong>같이 살펴보기</strong><p>마음과 두 단서가 어떻게 이어지는지 살펴봐요.</p></div></li>
        </ol>
